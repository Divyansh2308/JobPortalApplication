...
import com.projects.jp.util.FileUploadUtil;
...
public class RecruiterProfileController {
    ...
    public String recruiterProfile(Model model) {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            User users = userRepo.findByEmail(currentUsername).orElseThrow(() -> new UsernameNotFoundException("Could not " + "found user"));
